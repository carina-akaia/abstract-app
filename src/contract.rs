...
/// The id of the app
pub const APP_ID: &str = "akaia:demo-app";
...
const DEMO_APP: DemoApp = DemoApp::new(APP_ID, APP_VERSION, None)
...
// Export handlers
#[cfg(feature = "export")]
abstract_app::export_endpoints!(DEMO_APP, DemoApp);

#[cfg(feature = "interface")]
abstract_app::cw_orch_interface!(DEMO_APP, DemoApp, AppInterface);
